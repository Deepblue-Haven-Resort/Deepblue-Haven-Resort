...
public class ReceptionistDTO {
    ...
    public static class DashboardView {
        ...
        public int getPendingCheckInsCount() { 
            return pendingCheckInsCount; }
        public void setPendingCheckInsCount(int pendingCheckInsCount) { 
            this.pendingCheckInsCount = pendingCheckInsCount; }

        public int getPendingCheckOutsCount() { 
            return pendingCheckOutsCount; }
        public void setPendingCheckOutsCount(int pendingCheckOutsCount) { 
            this.pendingCheckOutsCount = pendingCheckOutsCount; }

        public int getInHouseGuestsCount() { 
            return inHouseGuestsCount; }
        public void setInHouseGuestsCount(int inHouseGuestsCount) { 
            this.inHouseGuestsCount = inHouseGuestsCount; }
        ...
        public List<CheckInQueueItem> getCheckInQueue() { 
            return checkInQueue; }
        public void setCheckInQueue(List<CheckInQueueItem> checkInQueue) { 
            this.checkInQueue = checkInQueue; }

        public List<CheckOutQueueItem> getCheckOutQueue() { 
            return checkOutQueue; }
        public void setCheckOutQueue(List<CheckOutQueueItem> checkOutQueue) { 
        ...
        public List<AvailableRoomOption> getAvailableRoomsList() { 
    ...
    public static class CheckInQueueItem {
        ...
        public List<AvailableRoomOption> getAvailableRooms() { 
            return availableRooms; }
        public void setAvailableRooms(List<AvailableRoomOption> availableRooms) { 
    ...
    public static class CheckOutQueueItem {
        ...
        public long getNightsStayed() { 
            return nightsStayed; }
        public void setNightsStayed(long nightsStayed) { 
        ...
        public BigDecimal getTotalFolio() { 
            return totalFolio; }
        public void setTotalFolio(BigDecimal totalFolio) {
            this.totalFolio = totalFolio; }

        public String getRoomChargeStr() { 
            return roomChargeStr; }
        public void setRoomChargeStr(String roomChargeStr) { 
            this.roomChargeStr = roomChargeStr; }

        public String getServiceChargeStr() { 
            return serviceChargeStr; }
        public void setServiceChargeStr(String serviceChargeStr) { 
            this.serviceChargeStr = serviceChargeStr; }
        ...
        public String getTotalFolioStr() { 
            return totalFolioStr; }
        public void setTotalFolioStr(String totalFolioStr) { 
            this.totalFolioStr = totalFolioStr; }

        public BigDecimal getPricingRuleMultiplier() { 
            return pricingRuleMultiplier; }
        public void setPricingRuleMultiplier(BigDecimal pricingRuleMultiplier) { 
            this.pricingRuleMultiplier = pricingRuleMultiplier; }

        public String getPricingRuleNote() { 
            return pricingRuleNote; }
        public void setPricingRuleNote(String pricingRuleNote) { 
            this.pricingRuleNote = pricingRuleNote; }
        ...
        public Long getAppliedCustomerDiscountId() { 
            return appliedCustomerDiscountId; }
        public void setAppliedCustomerDiscountId(Long appliedCustomerDiscountId) { 
            this.appliedCustomerDiscountId = appliedCustomerDiscountId; }
