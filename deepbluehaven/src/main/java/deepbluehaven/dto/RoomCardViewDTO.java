...
public class RoomCardViewDTO {
    ...
    public String getResortValue() { 
        return resortValue; 
    }

    public void setResortValue(String resortValue) { 
    ...
    public int getGuestsValue() { 
        return guestsValue; 
    }

    public void setGuestsValue(int guestsValue) { 
