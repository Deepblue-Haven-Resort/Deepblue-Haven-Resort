...
public class ManagerDashboardDTO {
    ...
    public KpiStats getKpi() { 
        return kpi; }
    public void setKpi(KpiStats kpi) { 
        this.kpi = kpi; }

    public RevenueChartData getRevenueChart() { 
        return revenueChart; }
    public void setRevenueChart(RevenueChartData revenueChart) { 
        this.revenueChart = revenueChart; }

    public RoomStatusData getRoomStatus() { 
        return roomStatus; }
    public void setRoomStatus(RoomStatusData roomStatus) { 
        this.roomStatus = roomStatus; }

    public BookingFlowData getBookingFlow() { 
        return bookingFlow; }
    public void setBookingFlow(BookingFlowData bookingFlow) { 
        this.bookingFlow = bookingFlow; }

    public ServiceOrderSummary getServiceOrders() { 
        return serviceOrders; }
    public void setServiceOrders(ServiceOrderSummary serviceOrders) { 
        this.serviceOrders = serviceOrders; }

    public List<StaffPerformanceItem> getStaffPerformanceList() { 
        return staffPerformanceList; }
    public void setStaffPerformanceList(List<StaffPerformanceItem> staffPerformanceList) { 
        this.staffPerformanceList = staffPerformanceList; }

    public GuestExperienceSummary getGuestExperience() { 
        return guestExperience; }
    public void setGuestExperience(GuestExperienceSummary guestExperience) { 
        this.guestExperience = guestExperience; }

    public List<OperationalAlertItem> getOperationalAlerts() { 
        return operationalAlerts; }
    public void setOperationalAlerts(List<OperationalAlertItem> operationalAlerts) { 
        this.operationalAlerts = operationalAlerts; }

    public List<LiveActivityItem> getLiveActivities() { 
        return liveActivities; }
    public void setLiveActivities(List<LiveActivityItem> liveActivities) { 
    ...
    public static class KpiStats {
        ...
        public String getRevenueTodayStr() { 
            return revenueTodayStr; }
        public void setRevenueTodayStr(String revenueTodayStr) { 
            this.revenueTodayStr = revenueTodayStr; }
        ...
        public void setTodayBookingsCount(int todayBookingsCount) { 
        ...
        public void setTodayCheckOutCount(int todayCheckOutCount) { 
            this.todayCheckOutCount = todayCheckOutCount; }

        public int getAttentionRoomsCount() { 
            return attentionRoomsCount; }
        public void setAttentionRoomsCount(int attentionRoomsCount) { 
            this.attentionRoomsCount = attentionRoomsCount; }

        public int getCleaningRoomsCount() { 
            return cleaningRoomsCount; }
        public void setCleaningRoomsCount(int cleaningRoomsCount) { 
            this.cleaningRoomsCount = cleaningRoomsCount; }

        public int getMaintenanceRoomsCount() { 
            return maintenanceRoomsCount; }
        public void setMaintenanceRoomsCount(int maintenanceRoomsCount) { 
            this.maintenanceRoomsCount = maintenanceRoomsCount; }
    }
    ...
    public static class RevenueChartData {
        ...
        public List<Integer> getBarHeights() { 
            return barHeights; }
        public void setBarHeights(List<Integer> barHeights) { 
            this.barHeights = barHeights; }

        public String getGrowthPercentageStr() { 
            return growthPercentageStr; }
        public void setGrowthPercentageStr(String growthPercentageStr) { 
            this.growthPercentageStr = growthPercentageStr; }
    }
    ...
    public static class ServiceOrderSummary {
        ...
        public List<ServiceOrderItem> getRecentOrders() { 
            return recentOrders; }
        public void setRecentOrders(List<ServiceOrderItem> recentOrders) { 
    ...
    public static class GuestExperienceSummary {
        ...
        public void setAverageRatingStr(String averageRatingStr) { 
            this.averageRatingStr = averageRatingStr; }
        ...
        public int getVipGuestsCount() { 
            return vipGuestsCount; }
        public void setVipGuestsCount(int vipGuestsCount) { 
            this.vipGuestsCount = vipGuestsCount; }

        public String getReturningGuestsRateStr() { 
            return returningGuestsRateStr; }
        public void setReturningGuestsRateStr(String returningGuestsRateStr) { 
            this.returningGuestsRateStr = returningGuestsRateStr; }
